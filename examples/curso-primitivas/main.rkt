...
;;; main.rkt: evaluador de literales, variables y primitivas prefijas.
;;; Adaptado de 2.InterpretadorSimple.rkt para FLP Viewer.
;;; ==================================================================

;; Valores expresados = Número
;; Valores denotados  = Número
...
(define evaluar-expresion
  (lambda (exp amb)
    (cases expresion exp
      ...
      ;; Primitiva: los argumentos se evalúan en el mismo ambiente, en orden.
      (prim-exp (prim args)
        (let ((lista-numeros
